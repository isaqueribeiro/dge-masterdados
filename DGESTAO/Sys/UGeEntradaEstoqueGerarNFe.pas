...
type
  TfrmGeEntradaEstoqueGerarNFe = class(TfrmGrPadrao)
    ...
    TmrAlerta: TTimer;
    cdsCompraVALOR_TOTAL_BRUTO: TFloatField;
    cdsCompraVALOR_TOTAL_LIQUIDO: TFloatField;
    cdsCompraVALOR_BASE_ICMS_NORMAL_ENTRADA: TFloatField;
    cdsCompraVALOR_TOTAL_ICMS_NORMAL_ENTRADA: TFloatField;
    ...
    cdsCompraVALOR_TOTAL_PIS: TFloatField;
    cdsCompraVALOR_TOTAL_COFINS: TFloatField;
